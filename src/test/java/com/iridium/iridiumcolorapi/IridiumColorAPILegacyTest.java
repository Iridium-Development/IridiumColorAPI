...
class IridiumColorAPILegacyTest {
    ...
    void process() {
        ...
        assertEquals("§1§lT§1§le§3§ls§3§lt", IridiumColorAPI.process("<GRADIENT:2C08BA>&lTest</GRADIENT:028A97>"));
        assertEquals("§4§lT§a§le§b§ls§5§lt", IridiumColorAPI.process("<RAINBOW1>&lTest</RAINBOW>"));
